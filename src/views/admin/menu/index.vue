...
<div class="app-container calendar-list-container">
  <div class="filter-container">
     <el-button-group>
    <el-button class="btn_table_primary" type="primary" v-if="menuManager_btn_add" icon="plus" @click="handlerAdd">添加</el-button>
    <el-button class="btn_table_primary"  type="primary" v-if="menuManager_btn_edit" icon="edit" @click="handlerEdit">编辑</el-button>
    <el-button class="btn_table_primary"  type="primary" v-if="menuManager_btn_del" icon="delete" @click="handleDelete">删除</el-button>
  </el-button-group>
  </div>
  ...
  <el-col :span="16"  class="col-mt">
    ...
    <el-form :label-position="labelPosition" label-width="80px" :model="form" ref="form" :rules="rules">
      ...
      <!-- <el-form-item label="图标" prop="icon">
        ...
        <svg-icon v-if="form.icon" :icon-class="form.icon" style="width:1.5em;height:1.5em;"></svg-icon>
      </el-form-item> -->
      <!--外部菜单的URL地址,内部菜单可不填-->
      ...
      <el-form-item label="描述"   prop="description">
       ...
       <el-form-item v-if="formStatus == 'update'">
         ...
         <el-button class="btn_table_primary" type="primary" @click="update">更 新</el-button>
       </el-form-item>
      <el-form-item v-if="formStatus == 'create'">
        <el-button @click="onCancel">取 消</el-button>
        <el-button class="btn_table_primary" type="primary" @click="create">保 存</el-button>
      </el-form-item>
    </el-form>
     </el-card>
    <el-card class="box-card">
