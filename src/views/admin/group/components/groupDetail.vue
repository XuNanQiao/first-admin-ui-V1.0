...
<el-row>
  <el-col :span="24">
    <el-button-group class="btn_table_primary">
      <el-button type="primary" v-if="groupManager_btn_add" icon="plus" @click="handlerAdd"  class="btn_table_primary">添加</el-button>
      <el-button type="primary" v-if="groupManager_btn_edit" icon="edit" @click="handlerEdit"  class="btn_table_primary">编辑</el-button>
      <el-button type="primary" v-if="groupManager_btn_del" icon="delete" @click="handleDelete" class="btn_table_primary">删除</el-button>
      <el-button type="primary" v-if="groupManager_btn_resourceManager" @click="handlerAuthority" class="btn_table_primary">
        权限分配</el-button>
      <el-button type="primary" v-if="groupManager_btn_userManager" @click="handlerUser" class="btn_table_primary">
        关联用户</el-button>
    </el-button-group>
  </el-col>
  <el-col :span="8" class="col-mt">
    <el-input placeholder="输入关键字进行过滤" v-model="filterText"> </el-input>
    <el-tree class="filter-tree" :expand-on-click-node="false" :data="treeData" node-key="id" highlight-current :props="defaultProps" :filter-node-method="filterNode" ref="groupTree" @node-click="getNodeData" default-expand-all> </el-tree>
  </el-col>
  <el-col :span="16" class="col-mt">
    <el-form :label-position="labelPosition" label-width="80px" :model="form" ref="form">
      ...
      <el-form-item v-if="formStatus == 'update'">
        ...
        <el-button type="primary" v-if="groupManager_btn_edit" @click="update" class="btn_table_primary">更 新</el-button>
      </el-form-item>
      <el-form-item v-if="formStatus == 'create'">
        <el-button @click="onCancel">取 消</el-button>
        <el-button type="primary" v-if="groupManager_btn_add" @click="create" class="btn_table_primary">保 存</el-button>
      </el-form-item>
    </el-form>
  </el-col>
